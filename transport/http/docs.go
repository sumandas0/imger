...
const specJSON = `
{
  ...
  "info": {
    "version": "1.4.0",
    "title": "IMGER",
    "description": "Imger it is an HTTP service for image processing based on filters and profiles. Supported filters: overlay, rotate, blur, contrast, brightness, crop, gamma.",
    "contact": {
      "email": "sumandas.workplace@gmail.com"
    },
    "license": {
      "name": "MIT"
    }
